        ...
        <div className="flex items-center gap-3 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-4 mt-1">
              ...
              <span
                className={`px-2 py-0.5 text-xs font-medium rounded-full border capitalize ${getStatusColor(item.status)}`}
              >
                {item.status}
              </span>
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center gap-2 mb-4">
        <span
          className={`px-2 py-1 text-xs font-medium rounded-full border capitalize ${getStatusColor(item.status)}`}
        >
          {item.status}
        </span>
      </div>
          ...
          <>
            ...
            {item.url && (
              <Button
                ...
                variant="outline"
                size="icon"
                className="p-2 border-gray-200 rounded-lg hover:bg-gray-50 transition-colors"
              >
