...
export const UploadSection: React.FC<UploadSectionProps> = ({
  ...
  const isAnyFileUploading = uploadedFiles.some(
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <Card className="glass-card shadow-medium hover:shadow-strong transition-all duration-300">
        <CardHeader>
          ...
          <CardDescription>
            Drag and drop files here, or click to browse. Supports PDF, DOC,
            DOCX, and TXT files (max 10MB).
          </CardDescription>
        </CardHeader>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-muted-foreground">
                    Our AI will automatically extract key concepts, vocabulary,
                    and create study materials from any web content.
                  </p>
                </div>
              </div>
            </div>
