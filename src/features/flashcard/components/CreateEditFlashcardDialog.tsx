...
import { useCreateFlashcardMutation, useUpdateFlashcardMutation, useGetCategoriesQuery } from '../services/flashcardApi';
...
const CreateEditFlashcardDialog: React.FC<CreateEditFlashcardDialogProps> = ({
  ...
  const [createFlashcard, { isLoading: isCreating }] = useCreateFlashcardMutation();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.front.trim() || !formData.back.trim() || !formData.category) {
      toast({
        ...
        description: "Please fill in all required fields (Front, Back, Category)",
        variant: "destructive",
      });
      return;
    }
        ...
        <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto p-6">
          <DialogHeader className="pb-4">
            ...
            <p className="text-sm text-gray-600">
              {isEdit ? 'Update your flashcard details below.' : 'Add a new flashcard to your collection. Fill in the details below.'}
            </p>
          </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="front" className="text-sm font-medium">Front Side</Label>
              <Textarea
                id="front"
            ...
            <div className="space-y-2">
              <Label htmlFor="back" className="text-sm font-medium">Back Side</Label>
              <Textarea
                id="back"
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Input
                ...
                className="flex-1"
              />
              <Button type="button" variant="outline" size="sm" onClick={addTag} className="px-3">
                <Plus size={16} />
              </Button>
            </div>
            <p className="text-xs text-gray-500">{formData.tags.length}/10 tags added</p>
