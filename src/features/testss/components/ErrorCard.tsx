...
const ErrorCard = ({ sound, mistakes, improvement }: ErrorCardProps) => (
    <div className="flex flex-col bg-white border border-gray-200 rounded-lg">
        <div className="p-3 font-bold text-gray-800 border-b border-gray-200">{sound}</div>
        <div className="p-4 border-b border-gray-200">
            <span className="font-semibold text-sm text-gray-700">Words with Mistakes</span>
        ...
        <div className="p-4 bg-gray-50 rounded-b-lg">
            <span className="font-semibold text-sm text-gray-700">How to Improve</span>
