import type { TranscriptData, WordPronunciation, TranscriptSegment } from '../types/pronunciation.types';

// Mock data simulating Azure Pronunciation Assessment results
export const createMockTranscriptData = (): TranscriptData => {
  const mockWords1: WordPronunciation[] = [
    // Demo word với omission error - hiển thị trong [ ]
    {
      word: "the",
      accuracy: 30,
      offset: 1500,
      duration: 200,
      phonemes: [
        { phoneme: "ð", accuracy: 0, offset: 1500, duration: 0, expectedPhoneme: "ð", actualPhoneme: "", isCorrect: false },
    ...
    },
    {
      ...
      errors: [
        {
          ...
          suggestion: "Practice the 'aɪ' sound more clearly",
          expectedPhoneme: "aɪ",
          actualPhoneme: "ʌɪ",
          confidence: 85
        }
      ...
      syllables: [
        { syllable: "I", stress: false, accuracy: 45 }
      ]
    },
    // Demo word với insertion error - có [+] phía trước và từ tô đỏ
    {
      word: "really",
      accuracy: 35,
      offset: 2400,
    ...
    },
    {
      ...
      confidenceScore: 82,
      syllables: [
        { syllable: "need", stress: true, accuracy: 55 }
      ]
    },
    {
      word: "English",
    ...
    },
    {
      ...
      confidenceScore: 95,
      syllables: [
        { syllable: "to", stress: false, accuracy: 88 }
      ]
    },
    {
      word: "continue",
    ...
    },
    {
      ...
      confidenceScore: 97,
      syllables: [
        { syllable: "my", stress: false, accuracy: 92 }
      ]
    },
    {
      word: "work",
      ...
      confidenceScore: 90,
      syllables: [
        { syllable: "work", stress: true, accuracy: 85 }
      ]
    },
    {
      word: "in",
      ...
      confidenceScore: 70,
      syllables: [
        { syllable: "in", stress: false, accuracy: 58 }
      ]
    },
    {
      word: "software",
  ...
  const mockWords2: WordPronunciation[] = [
    {
      ...
      confidenceScore: 98,
      syllables: [
        { syllable: "And", stress: false, accuracy: 95 }
      ]
    },
    ...
    },
    {
      ...
      confidenceScore: 92,
      syllables: [
        { syllable: "my", stress: false, accuracy: 88 }
      ]
    },
    {
      word: "career",
      ...
      errors: [
        {
          ...
          suggestion: "Practice the American 'r' sound and stress the second syllable"
        }
      ],
      isStressed: true,
      isDuplicated: false,
    ...
    },
    {
      ...
      confidenceScore: 87,
      syllables: [
        { syllable: "path", stress: false, accuracy: 82 }
      ]
    }
  ];
  ...
  return {
    audioUrl: "https://commondatastorage.googleapis.com/codeskulptor-assets/week7-brrring.m4a", // Working short audio
...
export const createMockDataWithErrors = (): TranscriptData => {
  ...
  // Add comprehensive error examples for all Azure error types
  ...
  const omissionWord = data.segments[0].words.find(w => w.word === "practice");
  if (omissionWord) {
    omissionWord.errors = [{
      type: "omission",
      severity: "high",
  ...
  data.segments[1].words.push({
    ...
    errors: [{
      ...
      suggestion: "Practice varying your pitch and stress: SPEAK-ing with rising intonation",
      confidence: 85,
      errorDetails: {
        intonationScore: 25,
        stressAccuracy: 30,
  ...
  data.segments[0].text = "I need English to continue my work in software engineer together.";
